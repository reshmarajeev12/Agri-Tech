    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.TextField(blank=True, max_length=1000, null=True)),
                ('link', embed_video.fields.EmbedVideoField()),
                ('farmer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.customer')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
